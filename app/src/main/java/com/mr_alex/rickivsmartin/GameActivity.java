...
public class GameActivity extends Activity {
    ...
    private final int but_id[][] = {{R.id.b00, R.id.b01, R.id.b02, R.id.b03},
            {R.id.b10, R.id.b11, R.id.b12, R.id.b13},
            {R.id.b20, R.id.b21, R.id.b22, R.id.b23},
            {R.id.b30, R.id.b31, R.id.b32, R.id.b33}},

            dog_id[][] = {{R.drawable.dog01, R.drawable.dog06, R.drawable.dog03, R.drawable.dog04},
            {R.drawable.dog05, R.drawable.dog02, R.drawable.dog05, R.drawable.dog01},
            {R.drawable.dog03, R.drawable.dog04, R.drawable.dog02, R.drawable.dog06},
            {R.drawable.dog01, R.drawable.dog05, R.drawable.dog04, R.drawable.dog03}},

            cat_id[][] = {{R.drawable.cat01, R.drawable.cat06, R.drawable.cat03, R.drawable.cat04},
            {R.drawable.cat05, R.drawable.cat02, R.drawable.cat01, R.drawable.cat02},
            {R.drawable.cat04, R.drawable.cat03, R.drawable.cat05, R.drawable.cat06},
            {R.drawable.cat01, R.drawable.cat04, R.drawable.cat03, R.drawable.cat02}};
    ...
    private void newGame() {
        cards.getNewCards();
        numbSteps = 0;
        numbBestSteps = Integer.parseInt(readFile("fbs"));
    ...
    private void continueGame() {
        String text = getPreferences(MODE_PRIVATE).getString("save", "");
        int k = 0;
        for(int i = 0; i < N; i++)
            for(int j = 0; j < N; j++) {
        ...
        numbSteps = Integer.parseInt(readFile("fs"));
        numbBestSteps = Integer.parseInt(readFile("fbs"));
        tBestScore.setText(Integer.toString(numbBestSteps));
    ...
    private void saveValueBoard() {
        ...
        getPreferences(MODE_PRIVATE).edit().putString("save", text).commit();
        writeFile(Integer.toString(numbSteps), "fs");
    ...
    private void checkFinish() {
        if(cards.finished()) {
            ...
            if ((numbSteps < numbBestSteps) || (numbBestSteps == 0)) {
                writeFile(Integer.toString(numbSteps), "fbs");
